<?php
    ...
    Class ExceptionTypeEnum extends Enumeration {
        ...
        const ERRO_SENHA_CADASTRO = "A senha digitada não segue o padrão de segurança. Por favor, insira uma senha válida (Mínimo de 8 caracteres, 1 caractere maiúsculo, 1 caractere especial e 1 número.)";
